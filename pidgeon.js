...
function start_quiz() {
    step = 0
    $("#buttons").html("<p><a href='#' class='btn btn-primary btn-lg' id='yes' role='button'>Agree</a><a href='#' class='btn btn-primary btn-lg' id='no' role='button'>Disagree</a></p>");
    next_question(step);
